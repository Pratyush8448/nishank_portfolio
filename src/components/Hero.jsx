...
import { useTheme } from "../theme"
  ...
  return (
    <section
        id="home"
        className="
        relative h-screen flex flex-col md:flex-row items-center justify-center 
        text-center md:text-left px-6 overflow-hidden
        bg-white dark:bg-[#0e0018]
        "
        style={
          theme === "dark"
            ? {
      ...
      <div
        ...
        dark:bg-gradient-to-t dark:from-[#0e0018]/90 dark:via-[#0e0018]/60 dark:to-transparent
        "
      />
      ...
      <motion.div
        ...
        transition={{ duration: 1 }}
        className="
        z-10 max-w-xl backdrop-blur-md 
        bg-white/80 dark:bg-white/5 
        border border-violet-500/30 
        rounded-3xl px-8 py-10 shadow-xl
        "
      >
        <motion.h1
          initial={{ opacity: 0, y: 20 }}
        ...
        >
          <a
            href="#projects"
            className="flex items-center gap-2 px-5 py-3 rounded-xl bg-violet-500 text-white dark:text-black hover:bg-violet-600 transition-all shadow-lg"
          >
          ...
          <a
            href="#contact"
            className="flex items-center gap-2 px-5 py-3 rounded-xl border border-violet-400 text-violet-600 dark:text-violet-300 hover:bg-violet-500 hover:text-white dark:hover:text-black transition-all shadow-lg"
          >
            <FaEnvelope /> Contact
          </a>
        </motion.div>
