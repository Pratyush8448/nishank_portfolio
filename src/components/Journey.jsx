...
const educationData = [
  {
    ...
    icon: <FaSchool className="text-pink-500 dark:text-pink-400" />,
  },
  {
    year: '2022',
    title: 'Class 12 - Young Blood Public School (CBSE)',
    description: 'Scored 90% (450/500) | PCM + CS stream',
    icon: <FaSchool className="text-yellow-500 dark:text-yellow-400" />,
  },
  {
    year: '2023 - 2027',
    ...
    icon: <FaUniversity className="text-cyan-500 dark:text-cyan-400" />,
  },
  {
    year: '2023 - 2027',
    title: 'B.Sc. in Data Science - IIT Madras',
    description: 'Parallel degree in Data Science and Applications and AI',
    icon: <FaGraduationCap className="text-violet-500 dark:text-violet-400" />,
  },
]
  ...
  return (
    <section className="py-20 px-6 bg-white dark:bg-black text-black dark:text-white transition-colors duration-300">
      ...
      <motion.h2
        ...
        className="text-4xl font-bold text-center mb-16 text-violet-500 dark:text-violet-400"
      >
        My Journey
      </motion.h2>
      ...
      <div className="relative max-w-4xl mx-auto before:content-[''] before:absolute before:top-0 before:left-6 before:w-1 before:h-full before:bg-gradient-to-b before:from-violet-500 before:to-pink-400">
        ...
        {educationData.map((item, index) => (
          ...
          >
            ...
            p-5 rounded-xl backdrop-blur-md shadow-lg 
            hover:shadow-violet-500/30 transition-all">
              ...
              {/* Title */}
              <h3 className="text-black dark:text-white text-base font-bold mb-1">
                {item.title}
              </h3>
